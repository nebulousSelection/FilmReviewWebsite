        ...
        <div class="m-6">
            <?php
                if (isset($_GET["success"])) {
                    ...
                    echo "
                    <form method='POST' action='http://jfoster13.webhosting6.eeecs.qub.ac.uk/bingespark/api/process.php?login'>
                ...
                if (isset($_GET["account_does_not_exist"])) {
                    echo "
                        <div class='notification'>
                            There is no account with</br>that email. 
                        </div>
                    ";
